...
var sakuraImage = "https://djy.luotianyi.blue/elements/fallen/hua.png";
img.src = sakuraImage;

var yiImage = "https://djy.luotianyi.blue/elements/fallen/yi.png";

var leafImage = "https://djy.luotianyi.blue/elements/fallen/ye.png";

var mapleLeavesImage = "https://djy.luotianyi.blue/elements/fallen/feng.png";

var snowflakeImage = "https://djy.luotianyi.blue/elements/fallen/xue.png";
...
$(function () {
    ...
    if (jq == "春分" || jq == "清明" || jq == "谷雨" || jq == "立夏" || jq == "小满" || jq == "芒种" ) {
        img.src = sakuraImage;
    } else if (jq == "夏至" || jq == "立秋" || jq == "处暑" || jq == "白露" ) {
        img.src = leafImage;
    } else if (jq == "小暑" || jq == "大暑") {
        img.src = yiImage;
    } else if (jq == "秋分" || jq == "寒露" || jq == "霜降" || jq == "立冬" || jq == "小雪" || jq == "大雪") {
        img.src = mapleLeavesImage;
    } else if (jq == "冬至" || jq == "小寒" || jq == "大寒" || jq == "立春" || jq == "雨水" || jq == "惊蛰") {
   ...
   //开启飘落效果
    ...
    /*if (system.win || system.mac || system.xll) {
        //如果是电脑
        startFalling();
        else if (getCookie("font_family") == "sans-serif"){
            stopp()
        }
    } else{
    startFalling();
...
mashiro_global.font_control = new function () {
    ...
    this.ini = function () {
        if (document.body.clientWidth > 860) {
            if (!getCookie("font_family") || getCookie("font_family") == "serif")//选择到宋体
                $("body").addClass("serif");
                startFalling();    
                
        }
        if (getCookie("font_family") == "sans-serif") {//选择到黑体
            stopp();
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://djy.luotianyi.blue/elements/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                        lazyload();
        ...
        cached.find("li").each(function () {
            ...
            cached.on("click", "#" + tagid, function () {
                if (/* tagid =="white-bg" || */tagid == "dark-bg") {
                    mashiro_global.variables.skinSecter = false;//true为头图扩展 tagid对应目标
                    checkskinSecter();
                } else {
...
function coverVideoIni() {
    if ($('video').hasClass('hls')) {
        if (mashiro_global.variables.has_hls){
            ...
            $.getScript("https://djy.luotianyi.blue/cdn/js/src/16.hls.js", function(){
                loadHls();
...
loadCSS("https://djy.luotianyi.blue/cdn/css/APlayer.min.css");
...
var home = location.href,
    ...
    Siren = {
        ...
        splay: function () {
            ...
            document.styleSheets[0].insertRule('.headertop.filter-dot::before {bottom: 1200px}', 0);
            $('#landlord').css({
                "bottom":"-320px"
            });
            stopp();
        ...
        LV: function () {
            ...
            _btn.on('click', function () {
                if ($(this).hasClass('loadvideo')) {
                    var msgp = ["坐好小板凳，演出要开始咯！","精彩即将上演！","视频加载中，请耐心等待！","我润啦！","那我先藏起来啦！","不打扰你看视频啦！","视频马上就来！","视频马上好！马上好！"];
                    var p = Math.floor(Math.random()*msgp.length);
                    ...
                    if ($(this).hasClass('video-pause')) {
                        var msgp = ["唔。。。我好像睡着了。。。","我回来啦！","你的小可爱突然出现！","看累了？休息一会吧！"];
                        var p = Math.floor(Math.random()*msgp.length);
                        showMessage(msgp[p], 5000); 
                        ...
                        var msgp = ["我又润啦！","我又躲起来啦！","下半场开始！","演出继续！","这次看完嘛，让我多睡会。" ];
                        var p = Math.floor(Math.random()*msgp.length);
                        showMessage(msgp[p], 5000); 
        ...
        function() {
            if (window.AudioContext) {
                var e = new AudioContext,
                    t = "130.81 196.00 246.94 196.00 261.63 246.94 220.00 196.00 220.00 246.94 196.00 146.83 196.00 246.94 196.00 261.63 246.94 220.00 196.00 220.00 246.94 293.66 246.94 164.81 196.00 246.94 196.00 261.63 246.94 220.00 196.00 220.00 246.94 196.00 146.83 196.00 246.94 196.00 261.63 246.94 220.00 196.00 220.00 246.94 293.66 246.94" .split(" "), 
